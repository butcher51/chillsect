...
class ParticleSystems {
  ...
  doSingleEmit(type, gameObject, time) {
  ...
  flashLightTweenOnComplete() {
    if (this.gameObject.explodeLight) {
      this.gameObject.explodeLight.intensity = 0;
    }
  }

  flashLight(gameObject, intensity, time) {
  ...
  followShipWithEmitter(gameObject) {

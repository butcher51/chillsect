...
var ParticleSystems = function (state) {
...
ParticleSystems.prototype.constructor = ParticleSystems;

ParticleSystems.types = {
...
ParticleSystems.prototype.init = function () {
    ...
    for (var key in this.groupConfigs) {
        if (this.groupConfigs.hasOwnProperty(key)) {
            ...
            this.engine.scene.scene.add(group.mesh);
...
ParticleSystems.prototype.getGroupConfigs = function () {

    var t = this.engine.loader.resources['particle02'].texture;
...
ParticleSystems.prototype.emitterConfigs = {
    //blueLaserBullet: {
...
ParticleSystems.prototype.initLightBuffer = function () {
    ...
    for (var i = 0, len = 3; i < len; i++) {
        ...
        this.engine.scene.scene.add(light);
    }

};

ParticleSystems.prototype.getLightFromBuffer = function () {
...
ParticleSystems.prototype.getEmitterFromBuffer = function (type) {
...
ParticleSystems.prototype.doSingleEmit = function (type, gameObject, time) {
...
ParticleSystems.prototype.asteroidHit = function (gameObject) {
...
ParticleSystems.prototype.enemyHit = function (gameObject) {
...
ParticleSystems.prototype.explodeEnemy = function (gameObject) {
...
ParticleSystems.prototype.explodeShip = function (gameObject) {

    this.doSingleEmit(ParticleSystems.types.shipExplosion, gameObject, 600);

};

ParticleSystems.prototype.beforeExplodeAsteroid = function (gameObject) {

    var s2 = gameObject.size / 200;
    var e = this.emitters[ParticleSystems.types.asteroidExplosion][this.groups[ParticleSystems.types.asteroidExplosion].emitterIndex];
...
ParticleSystems.prototype.flashLightTweenOnUpdate = function () {
...
ParticleSystems.prototype.flashLightTweenOnComplete = function () {
    if (this.gameObject.explodeLight) {
        this.gameObject.explodeLight.intensity = 0;
    }
};

ParticleSystems.prototype.flashLight = function (gameObject, intensity, time) {
    ...
    new TWEEN.Tween({gameObject: gameObject, intensity: intensity, c: gameObject.explodeLight.intensity})
        ...
        .start(this.engine.time);

};

ParticleSystems.prototype.explodeAsteroid = function (gameObject) {
...
ParticleSystems.prototype.followShipWithEmitter = function (gameObject) {

    var emitter = this.emitters[ParticleSystems.types.shipExplosion][this.groups[ParticleSystems.types.shipExplosion].emitterIndex];
    emitter.position.value = emitter.position.value.set(gameObject.position.x, gameObject.position.y, 5);

};

ParticleSystems.prototype.followExplodeEnemy = function (gameObject) {
...
ParticleSystems.prototype.update = function () {

    for (var key in this.groupConfigs) {
        if (this.groupConfigs.hasOwnProperty(key)) {
            this.groups[key].tick(this.state.delta);
        }
    }

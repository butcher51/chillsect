...
Main.prototype.restart = function () {
    ...
    this.engine.loader.loadLevel("levels/" + LevelManager.getLevelState().level + ".json", (levelData) => {
...
Main.prototype.update = function () {
    ...
    if (this.ship) {
        ...
        if (this.ship.active === true) {
            ...
            this.engine.scene.camera.position.x += (this.ship.position.x - this.engine.scene.camera.position.x) * 0.2;
            this.engine.scene.camera.position.y += (this.ship.position.y - this.engine.scene.camera.position.y) * 0.2;

...
var Sounds = function (state) {
    ...
    var gatlingWeaponSound = [];
    for (var i = 0; i < 12; i++) {
        var sound = new Audio(this.engine.audioListener);
        sound.setBuffer(this.engine.loader.resources['gatlingWeaponSound'].buffer);
        gatlingWeaponSound[i] = sound;
    }
    this.sounds.gatlingWeapon = gatlingWeaponSound;

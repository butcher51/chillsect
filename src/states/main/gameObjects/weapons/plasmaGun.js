...
class PlasmaGun extends BasicWeapon {

	projectileIndex = 0;
	projectileForce = 1200;

	blockTime = 0.3;

	// getters, not fields: read during super() -> initProjectiles() (see laserGun.js)
	get strength() { return 15; } //              1/0.4 * 100      =   250 hp/sec
	get projectileLife() { return 80; }
	...
	releaseProjectile(direction, angle, index) {

...
GatlingGun.prototype.blockTime = 0.060;// TODO UJRA SZÁMOLNI
GatlingGun.prototype.strength = 10;//  1/0.1 * 15     =       150 hp/sec
...
GatlingGun.prototype.playShootSound = function () {
    this.state.sounds.play("gatlingWeapon");
};
...
GatlingGun.prototype.initProjectiles = function () {
    ...
    for (var i = 0; i < this.projectileBufferSize; i++) {
        this.projectileBuffer.push(
            new Projectile(this.engine,
                ParticleSystems.types.redLaserBullet,
                this.projectileLife,
                this.strength
            )
        );

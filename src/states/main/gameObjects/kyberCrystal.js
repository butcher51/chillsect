...
KyberCrystal.prototype = Object.create(Object3D.prototype);
KyberCrystal.prototype.constructor = KyberCrystal;

KyberCrystal.materialBuffer = [];

KyberCrystal.prototype.pickup = function () {
...
KyberCrystal.prototype.setAleas = function (aleas) {
...
KyberCrystal.prototype.color = new Color(1, 1, 1);

KyberCrystal.prototype.collisionMask = CONFIG.COLLISION_MASK.SPACE_OBJECT;

KyberCrystal.prototype.aleas = [];

KyberCrystal.prototype.enable = function () {
...
KyberCrystal.prototype.disable = function () {
...
KyberCrystal.prototype.update = function () {

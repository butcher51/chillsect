...
var Contrail = function (engine, texture, width = 1, thrust = 0.3) {
    ...
    geometry.addAttribute('objectPositions', new BufferAttribute(new Float32Array(geometry.attributes.position.count * 3), 3));
    geometry.addAttribute('objectVelocities', new BufferAttribute(new Float32Array(geometry.attributes.position.count * 3), 3));
    geometry.addAttribute('objectRotations', new BufferAttribute(new Float32Array(geometry.attributes.position.count * 1), 1));
    geometry.addAttribute('objectRolls', new BufferAttribute(new Float32Array(geometry.attributes.position.count * 1), 1));
...
Contrail.prototype = Object.create(Mesh.prototype);
Contrail.prototype.constructor = Contrail;

Contrail.prototype.break = 5;
Contrail.prototype.length = 50;
Contrail.prototype.positionHistory = [];

Contrail.prototype.reset = function (objectPosition, objectRotation, objectRoll, objectVelocity) {
    this.positionHistory = [];
    for (var i = this.length; i > 0; i--) {
...
Contrail.prototype.update = function (objectPosition, objectRotation, objectRoll, objectVelocity) {

import {Mesh, PlaneBufferGeometry, RepeatWrapping, ShaderMaterial, Vector2} from 'three';
...
var StarField = function () {
    ...
    var backgroundTexture = this.engine.loader.resources['starField0Background'].texture;
    backgroundTexture.wrapS = RepeatWrapping;
    backgroundTexture.wrapT = RepeatWrapping;
    backgroundTexture.repeat.set(1, 1);

    var layer1Texture = this.engine.loader.resources['starField0Layer1'].texture;
    ...
    var cloudsTexture = this.engine.loader.resources['starField0Clouds'].texture;
    cloudsTexture.wrapS = RepeatWrapping;
    cloudsTexture.wrapT = RepeatWrapping;
    cloudsTexture.repeat.set(1, 1);


    var starTexture = this.engine.loader.resources['star'].texture;
    ...
    var material = new ShaderMaterial({
        uniforms: {
            ...
            resolution: {value: new Vector2(this.engine.scene.cameraSize.width, this.engine.scene.cameraSize.height)},
            ambient: {value: this.state.lights.defaultColor}
        },
...
StarField.prototype = Object.create(Mesh.prototype);
StarField.prototype.constructor = StarField;

StarField.prototype.resize = function () {

    this.material.uniforms.resolution.value.x = this.engine.scene.cameraSize.width;
    this.material.uniforms.resolution.value.y = this.engine.scene.cameraSize.height;

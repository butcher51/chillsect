...
var Lights = function (state) {

    this.state = state;
    this.engine = state.engine;


    // this.ambient = new AmbientLight(this.defaultColor.clone());
    // this.engine.scene.scene.add(this.ambient);

    // this.lights = [
    //     [0, 0, 4000 * 4000, 2, 0, 0],// TODO valahogy megadni a csillag fényét a pálya konfigból
    //     [0, 0, 2000 * 2000, 0, 0, 0],
    // ];
...
Lights.prototype.defaultColor = new Color(.25, .25, .25);

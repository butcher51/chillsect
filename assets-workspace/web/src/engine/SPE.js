...
SPE.ShaderAttribute.prototype.forceUpdateAll = function() {
  ...
  this.bufferAttribute.usage = DynamicDrawUsage;
...
SPE.shaderChunks = {
  ...
  uniforms: ["uniform float deltaTime;", "uniform float runTime;", "uniform sampler2D texture;", "uniform vec2 textureCrop;", "uniform float scale;"].join("\n"),
  ...
  //
  varyings: ["varying vec4 vColor;"].join("\n"),
...
SPE.Group = function(options) {
  ...
  this.uniforms = {
    ...
    textureCrop: {
      type: "v2",
      value: new Vector4(this.textureCrop.x, this.textureCrop.y)
    },
    // textureAnimation: {
    //     type: 'v4',
    //     value: new Vector4(

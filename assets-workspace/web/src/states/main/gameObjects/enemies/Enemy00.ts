...
export default class Enemy00 extends AbstractEnemy {
  public accel = 50;
  ...
  constructor() {
    ...
    var protoScene = Game.engine.loader.resources['enemy00ModelAnim'].scene;

    if (!Enemy00.material) {
      Enemy00.material = new MeshBasicMaterial({
        color: 0xffffff,
        map: Game.engine.loader.resources['enemy00Texture'].texture
      });
    }
